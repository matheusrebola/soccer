package soccervs.reciever.finalizacoes.core.documents;
...
public class Finalizacoes {
	...
	public Finalizacoes(String id, Float tempo, EFinalizacao finalizacao, EResultado resultado, Short eixoX, Short eixoY,
